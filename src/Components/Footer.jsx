...
import pagelogo from '../Assets/images/logo-footer.png';
export const Footer = () => {
    return (
        <div> <footer className="bg-dblack mt-5" id="BLOG">d
            <Container>
                <a href="#"><img src={pagelogo} alt="logo-footer" className="rotation-animation" /></a>
                <Row>
                    <Col xl={5}>
                        <p className="ff-poppins fs-2sm fw-normal lh-185 text-white-grey2 mb-2 max-448">
                        ...
                        <div className="d-flex align-items-center gap-20 pt-4 my-contact gap-3">
                            <a href="https://www.facebook.com/" target="_blank" className="text-decoration-none"><svg width="35" height="35"
                            ...
                            <a href="https://twitter.com/" target="_blank" className="text-decoration-none"><svg width="36" height="35"
                            ...
                            <a href="https://www.google.com/" target="_blank" className="text-decoration-none"><svg width="36" height="35"
                                viewBox="0 0 36 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <Col xl={7}>
                        <Row className="foot-show mt-xl-0 mt-4">
                            <Col md={3} xs={6} className='col-6'>
                                <ul className="ps-0 mb-0">
                                    <li className="text-white ff-poppins fs-md fw-semibold lh-150">
                                        CUSTOM LINKS
                                    </li>
                                </ul>
                                <ul className="ps-0 mb-0 pt-4">
                                    <li className="mb-3">
                                        <a href="#" className="text-decoration-none text-white-grey1 ff-poppins fs-md fw-normal lh-150 position-relative footer-underline">Lorem
                                            ipsum</a>
                                    </li>
                                    <li className="mb-3">
                                        <a href="#" className="text-decoration-none text-white-grey1 ff-poppins fs-md fw-normal lh-150 position-relative footer-underline">Lorem
                            ...
                            <Col md={3} xs={6} className='col-6'>
                                ...
                                <ul className="ps-0 mb-0 pt-4">
                                    <li className="mb-3">
                                        <a href="#" className="text-decoration-none text-white-grey1 ff-poppins fs-s-md fw-normal lh-150 position-relative footer-underline">Lorem
                                            ipsum</a>
                                    </li>
                                    <li className="mb-3">
                                        <a href="#" className="text-decoration-none text-white-grey1 ff-poppins fs-md fw-normal lh-150 position-relative footer-underline">Lorem
                            ...
                            <Col md={3} xs={6} className='col-6'>
                                <ul className="ps-0 mb-0">
                                    <li className="text-white ff-poppinsfs-s-md fw-semibold lh-150">
                                        YOUR ACCOUNT
                                    </li>
                                </ul>
                                <ul className="ps-0 mb-0 pt-4">
                                    <li className="mb-3">
                                        <a href="//https/" className="text-decoration-none text-white-grey1 ff-poppins fs-md fw-normal lh-150 position-relative footer-underline">Lorem
                                            ipsum</a>
                                    </li>
                                    <li className="mb-3">
                                        <a href="//https/" className="text-decoration-none text-white-grey1 ff-poppins fs-md fw-normal lh-150 position-relative footer-underline">Lorem
            ...
            <p className="text-white-grey1 text-center ff-poppins fs-md fw-normal lh-150 footerlastline mb-0 py-4">
