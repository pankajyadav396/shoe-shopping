...
import redshoes from '../Assets/images/relatedshoe1.png'
import grayshoes from '../Assets/images/relatedshoe2.png'
const myimg = [{
    img: redshoes,
},
{
...
export const Relatedsec = () => {
    const mycard = myimg.map((myimg) => (
        <Col lg={3} md={6} className='pb-4'>
            <div className="product-card pointer">
                <div className="position-relative overflow-hidden br-17">
                    <img src={myimg.img} alt="red-product" className="w-100 image-texture" />
                    <p className="text-white ff-poppins fs-1sm fw-normal lh-34 bg-off-sale position-absolute mb-0">
                        -10% OFF
                    </p>
                    <p className="text-white ff-poppins fs-1sm fw-normal lh-34 position-absolute new-text mb-0">
                        NEW
                    </p>
                </div>
                <div className="prize-detail">
                    <div className="d-flex align-items-center justify-content-between">
                        <div>
                            <p className="mb-0 color_primery_gray fs-md ff-poppins fw-medium lh-34">
                                Quickiins Mens Shoes
                            </p>
                            <p className="text-light-grey ff-poppins fs-md fw-medium lh-134 mb-0">
                                $90.00 <span className="text-red2">$70.00</span>
                            </p>
                        </div>
                        <a href='//https/' className="cart"><svg width="49" height="49" viewBox="0 0 49 49" fill="none">
    ...
    return (
        <div className='py-5' id='FORUM'>
            <Container>
                <h2 className='fs-2lg fw-semibold ff-poppins text-black pb-4'>RELATED PRODUCT </h2>
                <Row>
                    {mycard}
                </Row>
                <div className="d-flex pt-5 gap-3 justify-content-end align-items-center">
                    <div className="btn-group gap-3" role="group" aria-label="Basic radio toggle button group"> <input type="radio"
                        className="btn-check" name="btnradio" id="btnradio1" checked="" /> <label
                            className="sec4-btn btn  fw-semibold d-flex align-items-center justify-content-center fs-3md lh-base text-light-black1 ff-poppins" for="btnradio1">1</label> <input
                            type="radio" className="btn-check" name="btnradio" id="btnradio2" /> <label
                            className="sec4-btn btn  fw-semibold fs-3md lh-base d-flex align-items-center justify-content-center text-light-black1 ff-poppins" for="btnradio2">2</label> <input
                            type="radio" className="btn-check" name="btnradio" id="btnradio3" /> <label
                            className="sec4-btn btn d-flex align-items-center justify-content-center fw-semibold text-light-black1 fs-3md lh-base ff-poppins" for="btnradio3">3</label> </div>
                    <p className="sec4-btn1 text-grey ff-poppins fs-2sm lh-1 d-flex justify-content-center cursor-pointer align-items-center p-0 m-0"> Next {">>"}
                    </p>
                </div>
            </Container>
        </div>
