...
import shoeimg from '../Assets/images/red-shoes-big-img.png'
import blackshoe from '../Assets/images/black-shoe.png'
import grayshoe from '../Assets/images/gray-shoe.png'
import blackredshoe from '../Assets/images/black-red-shoe.png'
import redshoe from '../Assets/images/red-small-shoe.png'
import star from '../Assets/images/star-group.svg'
import { Link } from 'react-router-dom';

export const Shoecart = () => {
    ...
    return (
        <div className=' pt-5 mt-4' id='SNEAKERS'>
            <Container xl='true' className='pt-2'>
                <Row>
                    <Col lg={6}>
                        <Tabs>
                            <TabPanel>
                                <img src={shoeimg} alt="blackshoe" className='w-100' />
                            </TabPanel>
                            <TabPanel>
                                <img src={blackshoe} alt="blackshoe" className='w-100  h-599' />                            </TabPanel>
                            <TabPanel>
                                <img src={grayshoe} alt="blackshoe" className='w-100 h-599' />                            </TabPanel>
                            <TabPanel>
                                <img src={blackredshoe} alt="blackshoe" className='w-100 h-599' />
                            </TabPanel>
                            <div className='d-flex flex-wrap justify-content-between mt-4 overflow-scroll-x'>
                                <TabList className="d-flex justify-content-between w-100 gap-4 p-0">
                                    <Tab className='tab-shoe'>
                                        <img src={redshoe} alt="blackshoe" /></Tab>
                                    <Tab className='tab-shoe'>
                                        <img src={blackshoe} alt="blackshoe" /></Tab>
                                    <Tab className='tab-shoe'>
                                        <img src={grayshoe} alt="blackshoe" />
                                    </Tab>
                                    <Tab className='tab-shoe'>
                                        <img src={blackredshoe} alt="blackshoe" />
                                    </Tab>
                                </TabList>
                            </div>
                        </Tabs>
                    ...
                    <Col lg={6} className='ps-xxl-5 pt-4'>
                        <h2 className='fs-2lg ff-poppins text-black pt-1 fw-semibold mb-3'>PREMIUM MENS SPORTS LATHER KEDS</h2>
                        <div className='d-flex gap-2 mb-3'>
                            <img src={star} alt="star" />
                            <p className='text-light-black1 fs-2md fw-normal ff-poppins lh-134'>( 5 Customer Review )</p>
                        </div>
                        <p className='fs-2md ff-poppins fw-normal text-white-grey-3 mt-3 mb-5 lh-185'>Sed nec ultricies felis, vitae facilisis ipsum. Morbi id turpis euismod, rhoncus tortor quis, lobortis sapien. Sed imperdiet nulla in leo ullamcorper, in finibus elit porta. Sed eget congue neque, mattis finibus neque. In vel dolor ac augue pretium </p>
                        <div className='d-flex align-items-center gap-3'>
                            <p className='fs-2md fw-medium lh-125 ff-poppins mb-0'>Qty:</p>
                            <button  className='qty-btn d-flex align-items-center gap-3 justify-content-center'>
                                <button onClick={handleDecrement} className='subbtn text-grey'>-</button>
                                <p className='ff-poppins fs-2md text-grey mb-0'>{counter}</p>
                                <button onClick={handleIncrement} className='addbtn text-grey'>+</button>
                            </button>
                            <Link to='/contact' className='btn-addcart text-nowrap'>Add to Cart</Link>
                        </div>
                        <div className='d-flex gap-3 mt-3 pt-1 align-items-center'>
                            <label for="cars" className='fs-2md fw-medium lh-125 text-black ff-poppins'>Size:</label>
                            <div className='select'>
                                <select name="size" id="size" className='size-holder pointer text-grey'>
                                    <option className='text-grey' value="S">S</option>
                                    <option className='text-grey' value="M">M</option>
                                    <option className='text-grey' value="L">L</option>
                                    <option className='text-grey' value="X">XL</option>
                                </select>
                            </div>
                        </div>
                        <div className="d-flex align-items-center gap-4 pt-3 mb-1">
                            <p className="mb-0 fs-m-md color-black fw-medium ff-poppins lh-125">
                                Color:
                            </p>
                            <div className="d-flex align-items-center gap-1">
                                <div onclick="myshowes('macth2')" className="box-border">
                                    <div className="box-red"></div>
                                </div>
                                <div onclick="myshowes('macth4')" className="box-border">
                                    <div className="box-mahrun"></div>
                                </div>
                                <div onclick="myshowes('macth1')" className="box-border">
                                    <div className="box-balck"></div>
                                </div>
                                <div onclick="myshowes('macth3')" className="box-border">
                                    <div className="box-gray"></div>
                                </div>
                            </div>
                        </div>
                        <div className="d-flex align-items-center pt-4 gap-4 border-custum-bottom pb-4">
                            <div className="d-flex align-items-center">
                                ...
                                <p className="mb-0 text-light-black fs-l-sm fw-light lh-125 ff-poppins">
                                    Compare
                                </p>
                            </div>
                            <div className="d-flex align-items-center">
                        ...
                        <div className="d-flex align-items-center gap-4 pt-4 my-contact">
                            <a href="#">
                            ...
                            <div className="d-flex gap-4">
                                ...
                                <a rel='noopener'
                                    href="https://www.pinterest.com/pinartindia/"
                                    target="_blank"
                                    className=""
                                >
